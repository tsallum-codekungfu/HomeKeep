...
const initialEquipment = [
  { id: 1, name: "Lawn Mower", brand: "Honda", model: "HRX217VKA", serial: "MAGA-1234567", icon: "🌿",
    tasks: [
  ...
  { id: 2, name: "HVAC System", brand: "Carrier", model: "24ACC636A003", serial: "CARR-9876543", icon: "❄️",
    tasks: [
  ...
  { id: 3, name: "Generator", brand: "Generac", model: "GP3500iO", serial: "GENR-5551234", icon: "⚡",
    tasks: [
  ...
  { id: 4, name: "Pressure Washer", brand: "Ryobi", model: "RY142300", serial: "RYOB-7778901", icon: "💧",
    tasks: [
...
export default function App() {
  ...
  const [newEquip, setNewEquip] = useState({ name: "", brand: "", model: "", serial: "", icon: "🔧" });
  ...
  function addEquipment() {
    ...
    setNewEquip({ name: "", brand: "", model: "", serial: "", icon: "🔧" }); setShowAddEquip(false);
  }
