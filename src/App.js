                ...
                <div key={eq.id} style={{...S.card,...(urgent>0?S.cardUrgent:soon>0?S.cardSoon:S.cardGood)}}>
                  ...
                  <div style={S.cardContent} onClick={()=>{setSelectedEquip(eq.id);setView("detail");setActiveTab("tasks");}}>
                    <div style={S.cardTopRow}>
                      ...
                      <div style={S.cardStatusDot(urgent>0?"red":soon>0?"amber":"green")}/>
                    </div>
...
const S = {
  ...
  cardStatusDot: (color) => ({ width: 10, height: 10, borderRadius: "50%", background: color==="red"?"#ef4444":color==="amber"?"#f59e0b":"#22c55e" }),
